    ...
    public void receiveEvent(CommonEvent commonEvent) {
        switch (commonEvent.getEventType()) {
            case AllenEventType.UPDATE_DOWNLOADING_PROGRESS:
                ...
                Log.e("DownloadingActivity","commonEvent.getData() = " + commonEvent.getData());
                Log.e("DownloadingActivity","progress = " + progress);
    ...
    private void updateProgress() {
        if (!isDestroy) {
            if (getVersionBuilder() != null && getVersionBuilder().getCustomDownloadingDialogListener() != null) {
                ...
                ProgressBar pb = (ProgressBar)downloadingDialog.findViewById(R.id.pb);
                pb.setProgress(currentProgress);
                TextView tvProgress = (TextView)downloadingDialog.findViewById(R.id.tv_progress);
                tvProgress.setText(String.format(getString(R.string.versionchecklib_progress), currentProgress));
                Log.e("DownloadingActivity","currentProgress = " + currentProgress);
