...
public class DownloadSupplierCallBack extends MyStringCallBack {

    HuiZhanBaseActivity activity;
    Handler mHandler;
    private String TAG = "DownloadSupplierCallBack";
    public DownloadSupplierCallBack(String mTips, Handler h, HuiZhanBaseActivity activity,OnDownloadCallBackListener listener) {
        this.mTips = mTips;
    ...
    public void onResponse(String response, int id) {
        ...
        if (Service.checkType(bean.getType())) {
            ...
            SupplierList l = GsonUtil.toSupplierList(response);


            LogUtil.e(TAG, "SupplierList = " + l.getData().toString());
