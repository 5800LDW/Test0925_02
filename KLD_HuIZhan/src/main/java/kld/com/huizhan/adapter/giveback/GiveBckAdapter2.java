...
public class GiveBckAdapter2 extends RecyclerView.Adapter<GiveBckAdapter2.ViewHolder> {
    ...
    public GiveBckAdapter2(List<GiveBackAssets> giveBackAssetsList, HashMap<String,Integer> checkHashMap, OnContentClickListener l) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_giveback_2, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        LogUtil.e(TAG,"gba.toString()" + gba.toString());
            ...
            //出库数量
            String actualNum = gba.getOutDepotNum();
...
//            holder.tModel.setText(model);
        ...
        setText(mContext,holder.tvName,sb.toString());
...
//      String text = String.format("￥%1$s  门市价:￥%2$s", 18.6, 22);//<color name="amaranth">#E72F58</color><color name="paco">#524438</color>
        String text = String.format(content);
        int BillBefore = text.indexOf("名称:");
        int storageBefore = text.indexOf("条码:");
