...
public class CheckedLookAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CheckedLookAdapter(List<AssetsCheck> list, OnContentClickListener l) {
        this.list = list;
        listener = l;
    }
