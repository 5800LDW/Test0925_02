 ...
 */
@Deprecated
public class CheckedLookAdapterBackup extends RecyclerView.Adapter<CheckedLookAdapterBackup.ViewHolder> {
...
//        View vModify;
    ...
    public CheckedLookAdapterBackup(List<AssetsCheck> list, OnContentClickListener l) {
        this.list = list;
        listener = l;
    }
