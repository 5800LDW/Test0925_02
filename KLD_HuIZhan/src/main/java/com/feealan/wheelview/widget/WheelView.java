...
public class WheelView extends View {
    ...
    private void init(Context context) {
        ...
        //设置画笔颜色
        selectPaint.setColor(context.getResources().getColor(android.R.color.white));
        //设置文字大小
        ...
        //设置画笔颜色
        unSelectPaint.setColor(context.getResources().getColor( R.color.wheel_unselect_text));
        //设置文字大小
        ...
        //设置画笔颜色
        centerLinePaint.setColor(context.getResources().getColor( R.color.wheel_select_text_bg));
