...
//    private static SweetAlertDialog pDialog;
    ...
    public static SweetAlertDialog show2(final Context context, String info, final SweetAlertDialog dialog, final OnFinishListener listener) {
        if (info == null) {
    ...
    public static SweetAlertDialog show(final Context context, String info, CountDownTimer mCountDownTimer, @Nullable final OnFinishListener listener) {
//        if (listener != null) {
//            mListener = listener;
//        }
...
//                }
    ...
    public static void upLoadSucceed(final SweetAlertDialog d, Handler handler) {
        d.setTitleText("提交成功")
                .setConfirmText("好的")
    ...
    public static Dialog reminderDialog(Context context, String content, final OnReminderDialogListenter listenter) {
    ...
    public static Dialog reminderDialog2(Context context, String title, String content, final OnReminderDialogListenter listenter) {
        SweetAlertDialog dialog = new SweetAlertDialog(context, SweetAlertDialog.WARNING_TYPE)
                .setTitleText(title)
                .setContentText(content)
                .setCancelText("取消")
    ...
    public static Dialog reminderDialog4(Context context, String title, final OnReminderDialogListenter listenter) {
        SweetAlertDialog dialog = new SweetAlertDialog(context, SweetAlertDialog.WARNING_TYPE)
                .setTitleText(title)
                .setCancelText("取消")
                .setConfirmText("是的")
    ...
    public static Dialog reminderError(Context context, String title,String content) {
    ...
    private static SweetAlertDialog getDialog(Context context, final OnConfirmListener listener, String title) {
        SweetAlertDialog dialog = new SweetAlertDialog(context, SweetAlertDialog.WARNING_TYPE)
                .setTitleText(title)
                .setConfirmText("是的")
                .showContentText(false)
