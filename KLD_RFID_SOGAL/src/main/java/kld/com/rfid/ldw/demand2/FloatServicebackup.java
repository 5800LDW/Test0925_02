...
//
//@TargetApi(23)
//public class FloatServicebackup180913 extends MyBaseService implements OnClickListener , Runnable{
//
//
...
//                serviceStop.setClass(FloatServicebackup180913.this, FloatServicebackup180913.class);
...
//                                //发出声音
//                                //todo
//                                mediaPlayAllSound(mt);
//                                ToastUtil.showToast(mContext,sb.toString());
//                                if(!StringHelper2.isEmpty(obj.getMyPackage())){
//                                    Toast.makeText(mContext, "错误信息:"+obj.getMyPackage(), Toast.LENGTH_LONG).show();
//                                }
//                            }
//
//
...
////                                else{
////                                    //todo 提示错误
////                                    ToastUtil.showToast(mContext,strArr[i]+"");
////                                }
////
////
////                                break;
...
////                    testAlsert();
////                    Toast.makeText(mContext,
////                            "包异常:"+"\n"+"异常信息:"+"\n"+String.valueOf(obj.getMyPackage()),
////                            Toast.LENGTH_LONG).show();
////
////                }
////
////                //报警 todo
////                soundErrorMsg(obj.getErrormsg());
//
//
//
//
...
//
//
//    private void soundErrorMsg(String msg){
//
//        LogUtil.e("TAG","***错误信息*** ----------");
