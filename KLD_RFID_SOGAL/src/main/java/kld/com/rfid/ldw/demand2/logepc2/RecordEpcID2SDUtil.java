package kld.com.rfid.ldw.demand2.logepc2;
...
public final class RecordEpcID2SDUtil {
    ...
    private static String crashFolderName = "MyLogC";
     ...
     * @param //ex
     */
    public static void record(Context context, StringBuffer sb) {
        try {
            // 收集设备参数信息
//            collectDeviceInfo(context);
            // 保存日志文件
            saveCrashInfoFile(sb);
...
//    }
     ...
     * @throws Exception
     */
    private static String saveCrashInfoFile( StringBuffer sb) throws Exception {
