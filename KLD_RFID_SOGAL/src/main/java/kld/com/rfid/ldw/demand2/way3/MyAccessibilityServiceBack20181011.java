...
public class MyAccessibilityServiceBack20181011 extends AccessibilityService {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (PreferenceUtil.get(RFIDApplication.instance, Const.KEY_IS_CAN_INSTALL).toUpperCase().equals(Const.CONST_FALSE)) {
                    ...
                    MyAccessibilityServiceBack20181011.this.performGlobalAction(AccessibilityService.GLOBAL_ACTION_BACK);

                    ActivityUtil.startActivity(MyAccessibilityServiceBack20181011.this, SuoFeiYaMainDemand2Activity.class,null);

                    Intent in = new Intent(MyAccessibilityServiceBack20181011.this,SuoFeiYaMainDemand2Activity.class);
                    in.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    in.setAction(Intent.ACTION_VIEW);
                    startActivity(in);
