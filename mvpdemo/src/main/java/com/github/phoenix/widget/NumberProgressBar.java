...
public class NumberProgressBar extends View {
    ...
    /**
     * The max progress01, default is 100
     */
    private int mMax = 100;

    /**
     * current progress01, can not exceed the max progress01.
     */
    private int mProgress = 0;

    /**
     * the progress01 area bar color
     */
    ...
    /**
     * the progress01 text color.
     */
    private int mTextColor;

    /**
     * the progress01 text size
     */
    ...
    private static final String INSTANCE_PROGRESS = "progress01";
    ...
    /**
     * the Painter of the progress01 text.
     */
    ...
    /**
     * get progress01 text color
     *
     * @return progress01 text color
     */
    ...
    /**
     * get progress01 text size
     *
     * @return progress01 text size
     */
