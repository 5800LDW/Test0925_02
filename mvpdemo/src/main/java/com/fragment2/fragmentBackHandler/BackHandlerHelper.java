...
// */
//
//package com.fragment2.fragmentBackHandler;
//
...
//
//            //LDW这里设计得很精妙, 只对当前的fragment做处理, 如果都处理back好事件了,直接返回true,不再对其他viewPager的fragment处理(尽管其他fragment里面有子fragment);
...
//                && ((FragmentBackHandler) fragment).onBackPressed();//LDW 子Fragment有没有拦截,没有拦截, 就先把子fragment 里面的fragment一个接一个的pop掉(然后再处理activity的back事件)
//    }
//}
