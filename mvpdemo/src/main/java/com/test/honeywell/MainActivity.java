...
//		setContentView(com.example.sdembeddeddemo.R.layout.activity_main);
//
//		if (!SD_Loaded)
//		{
...
//		SD_Loaded = true;
//
//		findViewById(com.example.sdembeddeddemo.R.id.buttonDecode).setOnClickListener(new View.OnClickListener()
//		{
//			@Override
...
//						EditText editTextresult = (EditText)findViewById(com.example.sdembeddeddemo.R.id.editResult);
...
//		getMenuInflater().inflate(com.example.sdembeddeddemo.R.menu.main, menu);
//		return true;
//	}
//
//	@Override
...
//		if (id == com.example.sdembeddeddemo.R.id.action_settings) {
//			return true;
//		}
