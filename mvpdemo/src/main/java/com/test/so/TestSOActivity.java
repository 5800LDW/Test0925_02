...
public class TestSOActivity extends Activity {
	...
	private android.view.View.OnClickListener MyClickListener = new View.OnClickListener() {
		public void onClick(View v) {
			...
			switch (v.getId()) {
				...
				case R.id.ButTest: {
					...
					prn.prn_DrawLine(lineWidth,line_x1,line_y1,line_x1,line_y5);//侧边两列下拉
					prn.prn_DrawLine(lineWidth,line_x2,line_y1,line_x2,line_y5);//侧边两列下拉
					...
					//////
					prn.prn_DrawText(3, 20, "【送】", "32", 0x00, 0, 1, 0, 0 );
					prn.prn_DrawText(85, 15, "上海枢纽中心-青浦区", "32", 0x00, 0, 1, 0, 0 );

					prn.prn_DrawText(472, 10, "0001/1", "24", 0x00, 0, 1, 0, 0 );
					prn.prn_DrawText(472, 55, "1纸", "24", 0x00, 0, 0, 0, 0 );
					//
					prn.prn_DrawText(8, 118, "上海", "24", 0x00, 0, 1, 0, 0 );
					prn.prn_DrawText(20, 147, "市", "24", 0x00, 0, 1, 0, 0 );

					prn.prn_DrawText(77, 125, "-上海派送中心", "24", 0x11, 0, 1, 0, 0);
					//
					prn.prn_DrawText(18, 192, "D02", "24", 0x11, 0, 0, 0, 0 );
					prn.prn_DrawText(18, 245, "234", "24", 0x11, 0, 0, 0, 0 );
					//
					prn.prn_DrawText(15,305,"中国物流","24",0x00,0,0,1,0);
					...
					//
					prn.prn_DrawText(462, 242, "精准汽运(短途)", "24", 0x00, 0, 0, 0, 1);
					//
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_testso);
