...
import com.ldw.xyz.util.thread.ThreadUtil;
...
public class DownloadTask extends AsyncTask<String, Integer, Integer> {
    ...
    protected Integer doInBackground(String... params) {
        ...
        OkHttpClient client = new OkHttpClient().newBuilder().connectTimeout(15, TimeUnit.SECONDS).build();
        ...
        Log.e("TAG", "==== new Request.Builder() ====");


        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                Log.e("TAG", "==== 超时,报错: 线程名称:" +Thread.currentThread().getName());
//                if (e!=null&&e.getCause().equals(SocketTimeoutException.class)){
//                    Log.e("TAG", " ==== 超时,报错: ==== " + e.toString());
//                }
...
//                }
        ...
        Log.e("TAG", "==== 开始等待:" + Thread.currentThread().getName() + " wait ====");
//        synchronized (lock){
//            while (isWaited){
//                try {
//                    Thread.sleep(1000);
