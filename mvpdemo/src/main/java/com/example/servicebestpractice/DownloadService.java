...
public class DownloadService extends Service {
    ...
    class DownloadBinder extends Binder {
        ...
        public void startDownload(String url) {
            ...
            Log.e("TAG","startDownload:  url="+ url);
...
//                downloadTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR,"http://101.28.249.94/apk.r1.market.hiapk.com/data/upload/apkres/2017/4_11/15/com.baidu.searchbox_034250.apk");
//                downloadTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR,"http://softfile.3g.qq.com:8080/msoft/179/24659/43549/qq_hd_mini_1.4.apk");
//                downloadTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR,"http://www.zhaoshangdai.com/file/android.apk");
...
//            }
    ...
    private Notification getNotification(String title, int progress) {
        Intent intent = new Intent(this, BreakPointResumeActivity2.class);
