...
public class CameraActivity3 extends AppCompatActivity implements View.OnClickListener{
...
//    @OnClick({R.id.btn_update})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_update:
                ...
                //检查更新
                UpdateChecker.checkForDialog(CameraActivity3.this);
    ...
    private void showPicChooseView() {
        PermissionsManager.getInstance().requestPermissionsIfNecessaryForResult(CameraActivity3.this, new String[]{
            ...
            public void onGranted() {
                DialogUtil.showOpenPhoto(CameraActivity3.this, new ChoicePhotoDialog.CheckListener() {
                    @Override
                    ...
                    public void onClickCamera() {
                        ...
                        if (status.equals(Environment.MEDIA_MOUNTED)) {
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                                Uri imageUri = FileProvider.getUriForFile(CameraActivity3.this, "com.qqwl.fileprovider", mCurrentPhotoFile);
                            ...
                            Toast.makeText(CameraActivity3.this, "没有SD卡", Toast.LENGTH_LONG).show();
                        }
            ...
            public void onDenied(String permission) {
                Toast.makeText(CameraActivity3.this, "获取权限失败，请点击重试", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case PHOTO_PICKED_WITH_DATA://  相册返回
                ...
                String selectedImagePath = FileUtils.getPath(CameraActivity3.this, uri);
    ...
    public void startPhotoZoom(Uri uri) {
        ...
        String url = FileUtils.getPath(CameraActivity3.this, uri);

        Intent intent = new Intent("com.android.camera.action.CROP");
        //sdk>=24
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Uri imageUri = FileProvider.getUriForFile(CameraActivity3.this, "com.qqwl.fileprovider", new File(url));//通过FileProvider创建一个content类型的Uri
    ...
    private class PicAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(CameraActivity3.this).inflate(R.layout.adapter_mainpic, null);
                    ...
                    if (mpicList.size() < 10) {
                        ...
                        if (mpicList.size() == 10) {
                            if (mpicList.get(9).getUrl().equals("default")) {
                                ...
                                Toast.makeText(CameraActivity3.this, "最多只能上传10张图片", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
