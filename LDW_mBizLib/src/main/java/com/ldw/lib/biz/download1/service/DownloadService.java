package com.ldw.lib.biz.download1.service;//package com.ldw.xyz.download;
//
...
import com.ldw.lib.biz.download1.util.IOUtils;
import com.ldw.lib.biz.download1.util.InstallUtil;
import com.ldw.lib.biz.download1.util.SystemManager;
...
public class DownloadService extends Service {
    ...
    public class DownloadBinder extends Binder {
         ...
         * @param apkUrl 下载的url
         */
        public long startDownload(String apkUrl, String myApkName,String authorities) {
            mAuthorities =authorities;

            //点击下载
            //删除原有的APK
            IOUtils.clearApk(DownloadService.this, myApkName);
            //使用DownLoadManager来下载
            DownloadManager.Request request = new DownloadManager.Request(Uri.parse(apkUrl));
            //将文件下载到自己的Download文件夹下,必须是External的
            //这是DownloadManager的限制
            File file = new File(getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), myApkName);
    ...
    private class DownloadFinishReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!apkPath.isEmpty()) {
                ...
                InstallUtil.install(context, apkPath, mIsRoot, mAuthorities);
            } else {
