...
public class Test {
     ...
     * @return instance.
     */
    public Test defaultSavePath(String savePath) {
     ...
     * @return instance.
     */
    public Test retrofit(Retrofit retrofit) {
     ...
     * @return instance
     */
    public Test maxRetryCount(int max) {
     ...
     * @return instance
     */
    public Test maxDownloadNumber(int max) {
    ...
    public Observable<?> serviceDownload(final DownloadBean bean) {
        return createGeneralObservable(new GeneralObservableCallback() {
            @Override
            public void call() throws InterruptedException {
                downloadService.addDownloadMission(new SingleMission(Test.this, bean));
            }
        }).observeOn(AndroidSchedulers.mainThread());
    }
    ...
    public Observable<?> serviceMultiDownload(final List<DownloadBean> beans, final String missionId) {
        return createGeneralObservable(new GeneralObservableCallback() {
            @Override
            public void call() throws InterruptedException {
                downloadService.addDownloadMission(new MultiMission(Test.this, missionId, beans));
            }
        }).observeOn(AndroidSchedulers.mainThread());
    }
